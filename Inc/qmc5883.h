...
#define QMC5883P_REG_CONTROL1_VALUE 			0xAF ///< Control register 1 value
#define QMC5883P_REG_CONTROL2_VALUE 			0x08 ///< Control register 2 value



typedef struct _QMC5883P{
	int16_t Mag_X_RAW;
	int16_t Mag_Y_RAW;
	int16_t Mag_Z_RAW;
